...
local ElementParser = {}; do
    local function CreateParser(ElementType: string,
        LibaryIndex: string,
...
local function IsValidFolderPath(Name: string): boolean
    return typeof(Name) =="string" and (Trim(Name) ~="" and
...
local function ShowDialog(Condition: () -> boolean,
