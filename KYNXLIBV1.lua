...
local BaseURL = "https://raw.githubusercontent.com/rkiszox/kynx/refs/heads/main/"
...
do
    ...
    function CustomImageManager.GetExternalAsset(URL: string)
        ...
        local Path = string.format(
            "Kynx/external_assets/image_%d.%s",
...
function Library:CreateWindow(WindowInfo)
    ...
    -- constructors so it matches the Kynx window exactly.
